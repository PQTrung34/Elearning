...
import { addAnswer, addQuestion, addQuiz, addReplyToReview, addReview, deleteCourse, editCourse, generateVideoUrl, getAllCourses, getAllCoursesAdmin, getCourseByUser, getLanguage, getSingleCourse, reviewQuiz, shuffleAnswers, shuffleQuiz, uploadCourse } from "../controllers/course.controller";
...
courseRouter.post('/shuffle-quiz', shuffleAnswers);
